...
const defaultConfig = {
	...
	LogToFile: true,
	LogVerbose: true,
	HomepageFile: 'public_html/player.html',
...
var FRONTEND_WEBSERVER = '127.0.0.1';
...
// Block accidental legacy player.js access
app.get('/player.js', (req, res) => {
	console.warn('Blocked legacy player.js from loading');
	res.status(404).send('player.js not used');
  });
